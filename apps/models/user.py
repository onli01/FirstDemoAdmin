...
class User(db.Model):
  ...
  username  =  db.Column(String(16),  unique=True,  index=True)
  nickname  =  db.Column(String(16),  index=True)
  _password  =  db.Column(String(200))
  email  =  db.Column(String(64), nullable=True)
  role  =  db.Column(Integer,  default=0,  comment="0:  普通用户  1:  组长  2:  超级管理员")
